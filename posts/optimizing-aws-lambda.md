...
Instead you can use _batchWriteItem_ method, that will save all those records in one request.
...
![assets/Untitled%209.png](/assets/optimizing-aws-lambda/Untitled-9.png)
